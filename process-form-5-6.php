...
<body>
    <div class="process-form-styling">
        ...
        <center><h1><b><em>Our Answer:</em> <u>Eleanor Roosevelt</u></b></h1></center>
		...
		$cookie=0;
          ...
          if (strcasecmp($ans, $ans1) == 0) {
              echo 'Correct. You win $1000!';
			  $cookie = $_COOKIE[$counter]+1000;
        setcookie($counter, $cookie);
          } else {
            echo 'Incorrect. You lose $1000!';
			  $cookie = $_COOKIE[$counter]-1000;
        setcookie($counter, $cookie);
          }
        ?></b></h2></center>
        <center><a href="question5-6.php" class="button">BACK TO QUESTION</a></center>
        <br>
        <br>
